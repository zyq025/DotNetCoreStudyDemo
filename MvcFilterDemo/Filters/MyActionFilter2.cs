...
namespace MvcFilterDemo.Filters
{
    ...
    /// </summary>
    public class MyActionFilter2 : Attribute, IActionFilter, IOrderedFilter
    {
        ...
        public void OnActionExecuted(ActionExecutedContext context)
        {
            ...
            Console.WriteLine("OnActionExecuted方法执行====action");
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            Console.WriteLine("OnActionExecuting方法执行====action");
